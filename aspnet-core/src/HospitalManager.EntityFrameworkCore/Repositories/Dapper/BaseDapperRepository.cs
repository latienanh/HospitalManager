...
{
    public class BaseDapperRepository : DapperRepository<HospitalManagerDbContext>
    {
        public BaseDapperRepository(IDbContextProvider<HospitalManagerDbContext> dbContextProvider) : base(dbContextProvider)
        {
